...
function create_transaction(mins) {
    var table,
        ...
        address = get_random(),
        amount = Math.floor(30000 * Math.random()) + 1000,
...
(get_random = function(
    list = [
        "0xbe4" + startaddress() + generateId(40),
        "Binance 1",
        "0x99b0" + startaddress() + generateId(40),
        "LBank 7",
        "0x457bc41" + startaddress() + generateId(40),
        "BingX 3",
        "0x3efbcec" + startaddress() + generateId(40),
        "FTX",
        "0x5eda8" + startaddress() + generateId(40),
        "Huobi Global",
        "0xff841" + startaddress() + generateId(40),
        "Bitfinex ",
        "0x9d6a03a" + startaddress() + generateId(40),
        "Gate.io",
        "0x0bb77c3" + startaddress() + generateId(40),
        "Binance 3",
        "0x80aa4f" + startaddress() + generateId(40),
        "Coinone 2",
        "0x7cdff97" + startaddress() + generateId(40),
        "Upbit",
        "0x1df7fb0e" + startaddress() + generateId(40),
        "Coinbase Exchange",
        "0xb4c6b5d" + startaddress() + generateId(40),
        "Binance 3",
        "0x5eda81" + startaddress() + generateId(40),
        "KuCoin",
        "0x4f75d305b" + startaddress() + generateId(40),
        "Coinbase Exchange"
    ]
) {
